...
import { ExampleList, ExampleListSide } from "../../components/Example";
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.chatRoot}>
                {lastQuestionRef.current ? (
                    <aside>
                        <ExampleListSide onExampleClicked={onExampleClicked}></ExampleListSide> 
                    </aside>
                ) : null}
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h3 className={styles.chatEmptyStateTitle}>テンプレートで質問してみましょう</h3>
                ...
                >
                    ...
                    <Checkbox
                        ...
                        label="セマンティックランカーの利用"
                        onChange={onUseSemanticRankerChange}
                    />
                    <Checkbox
                        className={styles.chatSettingsSeparator}
                        checked={useSemanticCaptions}
                        label="セマンティックキャプションの利用"
