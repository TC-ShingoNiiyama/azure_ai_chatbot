...
export const Answer = ({
    ...
    return (
        <Stack className={parsedGptModel.current.startsWith('gpt-4') ? `${styles.answerContainerGPT4} ${isSelected && styles.selected}`: `${styles.answerContainerGPT3} ${isSelected && styles.selected}`} verticalAlign="space-between">
            <Stack.Item>
