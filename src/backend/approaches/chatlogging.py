...
connecting_string = os.environ.get("AZURE_COSMOSDB_STRING")
...
logger.addHandler(AzureLogHandler(connection_string=os.environ.get("AZURE_APPLICATIONINSIGHTS_CONNECTION_STRING")))
