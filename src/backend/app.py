...
AZURE_OPENAI_GPT_4_TURBO_DEPLOYMENT = os.environ.get("AZURE_OPENAI_GPT_4_TURBO_DEPLOYMENT")
...
gpt_models = {
    ...
    "gpt-4-turbo": {
        "deployment": AZURE_OPENAI_GPT_4_TURBO_DEPLOYMENT,
        "max_tokens": 127800,
        "encoding": tiktoken.encoding_for_model("gpt-4")
    },
}
...
openai.api_type = AZURE_OPENAI_HOST
